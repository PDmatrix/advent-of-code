...
The *immune system* and the *infection* each have (On second thought, it's pretty similar to regular reindeer immune systems.) an army made up of several *groups*; each *group* consists of one or more identical *units*.  The armies repeatedly *fight* until only one army has units remaining.
